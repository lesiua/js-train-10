...
function extendAndFreezeObject(obj1, obj2) {
	...
	const objAssFreeze = Object.freeze(Object.assign(obj1, obj2));
	if (Object.isFrozen(objAssFreeze)) {
		return objAssFreeze;
	}
...
function getObjectValuesSum(obj) {
	...
	return arrValue.reduce((sumNum, num) => sumNum + num);
